...
// Overlay con barra de progreso moderna
function createProgressOverlay() {
  ...
  overlay.innerHTML = `
    <div class="progress-card p-4 text-center shadow-lg" style="max-width:350px;width:90%; background: rgba(255,255,255,0.98); border-radius: 20px; border: 2px solid rgba(253, 126, 20, 0.2);">
      ...
      <p class="text-muted mb-3 small">Preparando tu documento de privacidad...</p>
...
// Toast de confirmación mejorado con sonido
...
// Generar PDF con progreso realista
// Generar PDF PROFESIONAL sin repeticiones
document.getElementById('downloadPdf').addEventListener('click', function () {
  ...
  html2canvas(element, {
    ...
    // Margenes de 15mm para mejor presentación
    const margin = 15;
    ...
    const filename = `Politica_Privacidad_Infojis.pdf`;
...
// Alerta inicial mejorada - REEMPLAZADA
